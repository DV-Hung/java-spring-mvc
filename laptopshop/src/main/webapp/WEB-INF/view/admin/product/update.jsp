            ...
            <head>
                ...
                <script>
                    $(document).ready(() => {
                        ...
                        const orgImage = "${oldProduct.image}";
                        if (orgImage) {
                                        ...
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/product/update"
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <label for="exampleInputPhone1" class="form-label">Detail
                                                        description:</label>
                                                    <form:input type="text"
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <form:select class="form-select" path="factory">
                                                        ...
                                                        <form:option value="3">SamSung</form:option>
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <form:select class="form-select" path="target">
                                                        ...
                                                        <form:option value="2">Văn Phòng</form:option>
                                                        <form:option value="3">SamSung</form:option>
                                                        <form:option value="4">LG</form:option>
                                                    </form:select>
                                                </div>
                                                ...
                                                <div class="col-12 mb-3">
                                                    <img alt="avatar preview" src="/images/product/${product.image}"
