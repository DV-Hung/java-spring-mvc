                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="item" items="${cartDetails}">
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4"><a href="/product/${item.product.id}"
                                                            target="_blank">${item.product.name}</a> </p>
                                                </td>
                                                <td>
                                                    <p class="mb-0 mt-4">
                                                ...
                                                <td>
                                                    <div class="input-group quantity mt-4" style="width: 100px;">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            data-detail-detail-index="${status.index}"
                                                            data-cart-detail-product-id="${item.product.id}">
                                                        <div class="input-group-btn">
                                                            <button
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4" data-cart-detail-id="${item.id}">
                                                        <fmt:formatNumber type="number"
                                                            value="${item.product.price * item.quantity} " /> đ
                                                    </p>
                                                </td>
                                                <td>
